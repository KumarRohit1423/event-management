...
import Table from "@/app/landing/past-events/_components/table";
import { inter } from "@/lib/fonts";
import { EventsTableSkeleton } from "@/app/ui/skeletons";
import { Suspense } from "react";
import { fetchPastEventsPages } from "@/lib/data";
	...
	return (
		<div className="w-full">
			<div className="flex w-full items-center justify-between">
				<h1 className={`${inter.className} text-2xl`}>Past Events</h1>
			</div>
